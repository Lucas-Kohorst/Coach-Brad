...
class App extends React.Component {
    ...
    render() {
        return ( <
            ...
            style = {
                { color: "white", paddingTop: "20vh", paddingLeft: "1em" }
            } >
            <
            /div> < /
            div > <
            ...
            onClick = {
                () => this.handleClick("https://teachablemachine.withgoogle.com/models/SrWBV53a/")
            } > Elbow < /Button> <
            Button className = "m-3"
            onClick = {
                () => this.handleClick("https://teachablemachine.withgoogle.com/models/kE9ERP1y/")
            } > Legs < /Button> < /
            div > <
            /div> < /
            React.Fragment >
